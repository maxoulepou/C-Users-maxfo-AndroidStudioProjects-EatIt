    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConnexionButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent ConnexionActivity = new Intent(MainActivity.this, com.example.eatit.Controleur.ConnexionActivity.class);
        ...
        mCreateCompte.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent CreationCompteActivity = new Intent(MainActivity.this, com.example.eatit.Controleur.CreationCompteActivity.class);
